...
/* ══════════════════════════════════════════════════════════════
   Icons — paths defined ONCE outside component (not rebuilt on every render)
══════════════════════════════════════════════════════════════ */
const ICON_PATHS = {
...
/* ══════════════════════════════════════════════════════════════
   Shared UI Components — memo prevents re-renders when parent updates
══════════════════════════════════════════════════════════════ */
export const Fld = memo(function Fld({ label, value, onChange, type="text", ph="", readOnly }) {
  return (
    <div>
...
export const ST = memo(function ST({ children, style:sx }) {
...
export const StatC = memo(function StatC({ label, val, sub, acc }) {
  return (
...
export const Toast = memo(function Toast({ t }) {
  if (!t) return null;
...
export function useIsMobile() {
  ...
  useEffect(()=>{
    let timer;
    const h = () => { clearTimeout(timer); timer = setTimeout(()=>setM(window.innerWidth<769), 100); };
